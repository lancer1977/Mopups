# Mopups portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 6
- Files changed (90 days): 23
- Last signal: 52dc47d (4 days ago)
- Top modified areas: docs(8);00_agile(6);tests(5);SampleMaui(1);README.md(1);Mopups(1)
- Notes: clean_at_scan
...
- [ ] Document owner and intent for area: docs(8)
